...
<link href="/jollibee/public/css/home.css" rel="stylesheet">

<body>
    <!-- header -->
    <div class="w3_navigation">
        <div class="container">
            <nav class="navbar navbar-expand-lg w3_navigation">
                <a class="navbar-brand" href="index.php">
                    JOLLI <span>TOWN</span>
                    <p class="logo_w3l_agile_caption">THEM PARK</p>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#theme">Menu</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#service">Calendar</a>
                        </li>
                        <li class="nav-item">
    ...
    <div id="availability-agileits">
        <div class="col-md-12 book-form-left-w3layouts">
            <a href="index2.html">
                <h2>WELCOME TO JOLIITOWN THEME PARK!!</h2>
            </a>
        </div>
